...
/******Public Define******/
/*boot file location*/
#define BOOT_FILE_LOCATION "/vendor/firmware/miniBoot.bin"
/*basic code location*/
#define BASIC_FILE_LOCATION "/vendor/firmware/TBM_D2.bin"
/*advanced code location*/
#define ADVANCED_FILE_LOCATION NULL
/*scenario table location*/
#define SCENARIO_TABLE_FILE_LOCATION "/vendor/firmware/SCTable.asb"
