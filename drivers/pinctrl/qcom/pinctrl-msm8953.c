...
static const struct msm_pingroup msm8953_groups[] = {
	...
	PINGROUP(35, gpio/*cci_timer2*/, blsp1_spi, pwr_nav_enabled_a, NA, NA, NA,
	...
	PINGROUP(47, gpio/*blsp6_spi*/, qdss_tracedata_b, NA, dac_calib13, NA, NA, NA,
		 NA, NA),
	PINGROUP(48, gpio/*blsp6_spi*/, NA, qdss_cti_trig_in_b1, NA, dac_calib14, NA,
		 NA, NA, NA),
