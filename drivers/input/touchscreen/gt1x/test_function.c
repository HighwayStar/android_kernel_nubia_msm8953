...
char save_result_dir[250] = "/sdcard/tp_key_rawdata/";
...
static s32 _get_test_parameters_array(void)
{
	...
	if (test_types & _VER_GREATER_CHECK) {
...
TEST_START:
	...
	FORMAT_PATH(save_path, save_result_dir, "tp_rawdata");
